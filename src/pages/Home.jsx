  ...
  return (
    <div className="container">
      ...
      <div className="content__items">
        {isLoaded ?
          items.map(obj => <PizzaBlock onClickAddPizza={handleAddPizzaToCart} key={obj.id} addedCount={cartItems[obj.id] && cartItems[obj.id].length} {...obj} />) : Array(12).fill('').map((_, index) => <PizzaLoadingBlock key={index} />)
        }
      </div>
    </div>
  )
